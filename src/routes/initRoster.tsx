...
import { getRosters, createRosterFromInit, getRosterById } from "../lib/rosterApi"; 
...
export default function InitRostersPage() {
  ...
  return (
    <div class="p-6 w-full mx-auto">
      <h1 class="text-3xl font-bold mb-8 text-gray-800">Team Roster Manager</h1>
      
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        {/* Roster list column */}
        <div class="lg:col-span-1 bg-white p-5 rounded-lg shadow-md">
          <h2 class="text-xl font-semibold mb-4 text-gray-700 border-b pb-2">Available Rosters</h2>
      ...
      <Show when={showPopup()}>
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div class="bg-white p-6 rounded-lg shadow-lg w-96 max-w-md">
            <h3 class="text-xl font-semibold mb-2 text-gray-800">Create New Roster</h3>
            <p class="text-gray-600 mb-4">Enter a name for your new roster</p>
            <input
            ...
            <div class="flex justify-end space-x-3">
              ...
              <button
                ...
                disabled={creating() || !customRosterName().trim()}
              >
